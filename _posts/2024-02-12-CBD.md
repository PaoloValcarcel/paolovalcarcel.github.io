...
You can interact with different layers by modifying the output options. For more information regarding the commands used, please feel free to email me on p.valcarcel@uniandes.edu.co

<div style="margin: auto; width: 80%;">
    <!-- Código HTML de tu gráfico -->
    <iframe src="\assets\Shapes\CBD_Map.html"></iframe>
</div>
